...
$query_st=pg_query($conexion,"select zona from iglesia where idpastor='$idpastorx'");
...
<div class="form-group">
  ...
  <?php
				...
				$query_s=pg_query($conexion,"select idiglesia,nombre from iglesia where idpastor is null and zona='$validaZona'");
