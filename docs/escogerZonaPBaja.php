  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
			 ...
			 <li role="presentation"><a  href="buscarBajaMO.php"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Zona Occidental</a></li>
            
                <li role="presentation"><a href="buscarBajaMC.php"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Zona Central</a></li>
				     
			    <li role="presentation"><a href="buscarBajaMOR.php"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Zona Oriental</a></li>
