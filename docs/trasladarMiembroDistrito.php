...
$query_st=pg_query($conexion,"select iddistrito from iglesia where idpastor='$idpastor'");
...
document.location.href="../config/fin.php";
  ...
  alertify.error("<h1>Error</h1>"+"<p>No tiene iglels&iacute;a asignada </p>"+"<img src='../img/error.png'>").dismissOthers();
    ...
    <li class="mobile-menu-button visible-xs" style="float: left !important;">
		 ...
		 <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Buscar Miembro A Trasladar<small></small></h1>
            </div>
        </div>
  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
            	<?php 
            	$conect=pg_query($conexion,"select distinct p.idpastor from pastor as p,iglesia as i where i.idpastor=p.idpastor");
            	if (pg_num_rows($conect)>0) {
            	 	
            	 ?>
                <li role="presentation"><a href="buscarMiembroTDistrito.php"><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>Buscar Miembro Propio</a></li>
                <?php }else{ ?>
                <li role="presentation" style="cursor: pointer" onClick="ver();"><a><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>Buscar Miembro Propio</a></li>
                <?php } ?>	
                <li role="presentation"><a href="buscarImTDistrito.php?zona=<?php echo base64_encode($Zona) ?>"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Buscar Miembro de otra iglesia</a></li>
