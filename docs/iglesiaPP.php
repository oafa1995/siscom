...
$query_s24=pg_query($conexion,"select idiglesia,nombre,direccion,telefono,iddistrito from iglesia where idpastor='$iddatos3' ");	
...
$direccion=pg_escape_literal($direccion);
   ...
   $result=pg_query($conexion,"UPDATE iglesia SET nombre={$nombre}, direccion={$direccion},telefono={$telefono} WHERE idiglesia='$idiglesiax'" );
