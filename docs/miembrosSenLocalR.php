...
$query_st=pg_query($conexion,"select idiglesia from iglesia where idpastor='$iddatos'");
...
<html>
<head>
    <title>Imprimiendo Sociedad de Señores a Nivel Nacional</title>
    <meta charset="UTF-8">
...
<article class="post clearfix"><a href="#" class="thumb pull-left"><img src="../img/sin.png" alt="espere un momento" class="img-responsive" width="100" height="100"></a>
 ...
 <h3>Registro de Miembros Activos Nivel Local: Sociedad de Señores&nbsp;&nbsp;&nbsp;<br>Iglesia Pentecostal del Nombre de Jesus&nbsp;&nbsp;&nbsp;</h3>
...
$query_s= pg_query($conexion, "select m.idmiembro,m.nombre,m.apellido,m.fechanacimiento,m.estadocivil,m.sexo,m.dui,mi.idiglesia from miembro as m,miembro_iglesia as mi,iglesia as i,cargo_pastor as cp where m.estado=1 and m.idmiembro=mi.idmiembro and (date_part('year',age(fechanacimiento))>=18 and m.estadocivil='Casado' and m.sexo='Masculino' or date_part('year',age(fechanacimiento))>=30 and m.estadocivil='Soltero' and m.sexo='Masculino' ) and i.idpastor=cp.idpastor and cp.idcargo=1 and mi.idiglesia='$zona' order by apellido");
...
<br>
       ...
       <tbody>
			    <?php
                        include("../config/conexion.php");
						$query_s= pg_query($conexion, "select m.idmiembro,m.nombre,m.apellido,m.fechanacimiento,m.estadocivil,m.sexo,m.dui,mi.idiglesia from miembro as m,miembro_iglesia as mi where m.estado=1 and m.idmiembro=mi.idmiembro and mi.idiglesia='$zona' order by apellido");
						while($fila=pg_fetch_array($query_s)){
						?>
			   <?php if((obtener_edad($fila[3])>=30 && $fila[4]=="Soltero" && $fila[5]=="Masculino") || (obtener_edad($fila[3])>=18 && $fila[4]=="Casado" && $fila[5]=="Masculino") ){ ?>
            <tr>
