...
$iddatos=$_SESSION["nivelUsuario"];
 if($_SESSION['autenticado']!="yeah" || $iddatos!=2  ){
...
function alertaExito(){
	...
	location.href="index.php"
		 ...
		 function alertaErrorSI(){
  alertify.error("<h1>Error</h1>"+"<p>No tiene una iglesia asignada</p>"+"<img src='../img/error.png'>").dismissOthers();
           ...
           <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Crear miembro para la iglesia: <?php //echo $rnombre; 
...
<div class="form-group">
  ...
  <div class="col-md-5">
   ...
   <input type="text" name="nombre" id="nombre" class="form-control" autocomplete= "off" placeholder="Nombres..." required>
...
<div class="form-group">
  ...
  <div class="col-md-5">
   ...
   <input type="text" name="apellido" id="apellido" class="form-control" autocomplete= "off" placeholder="Apellidos..." required>
...
<div class="form-group">
  ...
  <div class="col-md-2">
   ...
   <select  name="edad" id="edad" class="form-control" autocomplete= "off" placeholder="edad..." required readonly="readonly">
    <option value="" selected disabled>Edad generada</option>  
...
<div class="form-group" >
  ...
  <div class="col-md-2">
   <input type="text" name="dui" id="dui" class="form-control" autocomplete= "off">
...
<option value="" selected disabled>Escoja el sexo</option>  
...
<div class="form-group">
  ...
  <div class="col-md-3">
   ...
   <select name="sociedad" id="sociedad" class="form-control" autocomplete= "off" required>
		...
		<option value="" selected disabled>sociedad...</option>  
...
<div class="form-group">
  ...
  <div class="col-md-5">
   ...
   <input type="text" name="profesion" id="profesion" class="form-control" autocomplete= "off" placeholder="Profesion/Oficio..." required>
...
<div class="form-group">
  ...
  <div class="col-md-2">
   ...
   <input type="text" name="telefono" id="telefono" class="form-control" autocomplete="off" placeholder="telefono..." required>
...
pg_query("BEGIN");	
 ...
 $dui=pg_escape_literal($dui);
	...
	$query_s2=pg_query($conexion,"select * from miembro where dui={$dui} ");
...
$fila=pg_fetch_array($result);///obteniendo el id de la insercion recien hecha
		$idmiembro=$fila[0];
	
	
	$result22=pg_query($conexion,"insert into miembro_iglesia(idmiembro,idiglesia) values('$idmiembro','$idiglesia')");
