...
function mandar(id){
	//alert("sdjsdns"+id);
	window.open("modIglesiaDistrito.php?idpastor="+id, '_parent');
	}
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Buscar Igles&iacute;a:  <?php echo $zonaBusca; ?></span></h4>
                </li>
				</center>
...
<tbody>
    ...
    <?php $conect=pg_query($conexion,"select distinct i.idiglesia,i.nombre,i.direccion,i.departamento,i.municipio,i.zona,i.idpastor,i.encargadonp,i.iddistrito from iglesia as i,pastor as p where i.iddistrito='$zonaBusca'"); 
