...
<div class="form-group">
  <label class="col-md-4 control-label" for="nombre">Nombre del cargo</label>  
  <div class="col-md-5">
...
$query_s=pg_query($conexion,"select nombre from cargo where nombre={$nombre}" );
...
$result=pg_query($conexion,"INSERT INTO cargo(nombre, nivel,cargo_adicional) VALUES ({$nombre},2,2)" );
