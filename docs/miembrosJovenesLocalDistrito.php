...
if($_SESSION['autenticado']!="yeah" || $t!=4){
	header("Location: ../index.php");
	exit();
	}
include("../config/conexion.php");
$query_st=pg_query($conexion,"select iddistrito from iglesia where idpastor='$iddatos'");
...
<html>
<head>
    <title>Imprimiendo Sociedad de Jovenes a Nivel Nacional</title>
    <meta charset="UTF-8">
...
<article class="post clearfix"><a href="#" class="thumb pull-left"><img src="../img/sin.png" alt="espere un momento" class="img-responsive" width="100" height="100"></a>
 ...
 <h3>Registro de Miembros Activos Nivel Local: Sociedad de Jovenes&nbsp;&nbsp;&nbsp;<br>Iglesia Pentecostal del Nombre de Jesus&nbsp;&nbsp;&nbsp;</h3>
...
$query_s= pg_query($conexion, "select m.idmiembro,m.nombre,m.apellido,m.fechanacimiento,m.estadocivil,m.sexo,m.dui,mi.idiglesia from miembro as m,miembro_iglesia as mi,iglesia as i where m.estado=1 and m.idmiembro=mi.idmiembro and i.zona='$zona' order by apellido");
...
<br>
       ...
       <tbody>
			    <?php
                        include("../config/conexion.php");
						$query_s= pg_query($conexion, "select m.idmiembro,m.nombre,m.apellido,m.fechanacimiento,m.estadocivil,m.sexo,m.dui,mi.idiglesia from miembro as m,miembro_iglesia as mi where m.estado=1 and m.idmiembro=mi.idmiembro order by apellido");
						while($fila=pg_fetch_array($query_s)){
						?>
			   <?php if(obtener_edad($fila[3])<30 && $fila[4]=="Soltero"){ ?>
            <tr>
