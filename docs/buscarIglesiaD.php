...
$distrito=base64_decode($_REQUEST['iddatos2']);
...
function mandar(id){
	//alert("sdjsdns"+id);
	window.open("modIglesia.php?idpastor="+id, '_parent');
	}
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Buscar Igles&iacute;a</span></h4>
                </li>
				</center>
...
<tbody>
    ...
    <?php $conect=pg_query($conexion,"select distinct i.idiglesia,i.nombre,i.direccion,i.departamento,i.municipio,i.zona,i.idpastor,i.encargadonp,i.iddistrito from iglesia as i,pastor as p where i.zona='$zonaBusca' and i.iddistrito='$distrito'");
