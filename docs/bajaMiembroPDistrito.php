...
function alertaExito(){
	alertify.success("<h1>Exito</h1>"+"<p>Miembro dado de baja exitosamente</p>"+"<img src='../img/bien.png'>").set({transition:'flipx'});
	}	
	
	function r() {
	location.href="buscarMiembrobajapreDistrito.php"
} 
...
function mandar(id,nombre,apellido) { 
		alertify.confirm("<center>ATENCI&Oacute;N!</center>", "<center><img src='../img/warning.png' width='230' height='230'></center>"+"<center><h1>Desea dar de baja al miembro </h1><h2 style='font-style:italic';>"+nombre+" "+apellido+" ?</h2></center>    ", 
           ...
           <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Dar de baja miembro para la iglesia: <?php echo $rnombre; ?></span></h4>
                </li>
				</center>    
    ...
    <?php $conect=pg_query($conexion,"select m.idmiembro,m.nombre,m.apellido,m.sexo,m.fechanacimiento,m.dui,m.profeuofi,m.estadocivil from miembro as m,miembro_iglesia as mi where m.estado=1 and mi.idiglesia='$idiglesia' and m.idmiembro=mi.idmiembro "); 
      ...
      <tr>
		...
		<td align="left"><font size="3" ></font>sociedad de señores</td>
               ...
               <td align="left"><font size="4" ></font><button type="button" id="cancelar" name="cancelar" onClick="mandar('<?php echo ($vector[0]); ?>','<?php echo ($vector[1]); ?>','<?php echo ($vector[2]); ?>' )" class='btn btn-danger'>Dar de baja</button></td>
