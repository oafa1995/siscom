...
<br>
       ...
       <tbody>
			    <?php
                        include("../config/conexion.php");
						$query_s= pg_query($conexion, "select m.idmiembro,m.nombre,m.apellido,m.fechanacimiento,m.estadocivil,m.sexo,m.dui,mi.idiglesia from miembro as m,miembro_iglesia as mi where m.estado=1 and m.idmiembro=mi.idmiembro and mi.idiglesia=1 and mi.idiglesia='$zona' order by apellido");
