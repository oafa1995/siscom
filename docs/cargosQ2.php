...
$query_s3=pg_query($conexion,"select c.idcargo_senora,c.nombre_cargo from cargo_senora as c,detalle_senora as cp where cp.idpastor=$elegido and cp.idcargo_senora=c.idcargo_senora");
...
";
				...
				$query_s=pg_query($conexion,"select c.idcargo,c.nombre from cargo_senora as c,detalle_senora as cp where cp.idpastor=$elegido and cp.idcargo_senora=c.idcargo_senora");
