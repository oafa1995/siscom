...
function mandar(id){
	...
	function r() { location.href="asignarBaja.php" } 
...
<tbody>
    ...
    <?php $conect=pg_query($conexion,"select p.idpastor,p.nombre,p.apellido,p.fechanacimiento,p.estadocivil,p.dui,p.duiesposa,p.telefono,p.direccion,p.correo,p.fechain from pastor as p,cargo as c,cargo_pastor as cp,iglesia as i where p.idpastor=i.idpastor and c.nivel!=0  and cp.idpastor=p.idpastor and c.idcargo=cp.idcargo"); 
      ...
      <tr>
                       ...
                       ?>
                            ...
                            <td align="left"><font size="4" ></font><select id="cargo" name="cargo" class="form-control input-md" > <option value="" disabled selected><?php echo $vector3[0]; ?></option></select></td>
