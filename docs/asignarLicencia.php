...
/////////////////////////////////////////validacion nombre 
 ...
 function mandamos(){
  ...
  alertaError();
	...
	function r() { location.href="asignarLicencia.php"} 
...
$(document).ready(function (e) {
  $('#myModal').on('show.bs.modal', function(e) { 
     ...
     elegido=id;
      $.post("licencias.php", { elegido: elegido }, function(data){
            $("#licenciaa").html(data);
            });                  
  ...
  $(document).ready(function(){
   $("#licenciaa").change(function () {
           $("#licenciaa").each(function () {
            elegido=$(this).val();
...
$(document).ready(function (e) {
  $('#myModal2').on('show.bs.modal', function(e) { 
     var id = $(e.relatedTarget).data().id;
            ...
            $.post("cargosQ.php", { elegido: id }, function(data){
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Administrar Licencias</span></h4>
                </li>
				</center>
...
<tbody>
    ...
    <?php $conect=pg_query($conexion,"select distinct p.idpastor,p.nombre,p.apellido,p.fechanacimiento,p.estadocivil,p.licencia,p.duiesposa,p.telefono,p.direccion,p.correo,p.fechain from pastor as p,cargo as c,cargo_pastor as cp,iglesia as i where c.nivel!=0 and c.nivel!=1  and cp.idpastor=p.idpastor and c.idcargo=cp.idcargo and p.licencia is not null"); 
                       ...
                       ?>
                        ...
                        ?>
                            ...
                            <td align="left"><font size="4" ></font><?php echo dameFecha($vector[10]); ?></td>
                            	...
                            	<td align='left'><font size='4' ></font><button type='button' id='cancelar' name='cancelar' class='btn btn-success' data-controls-modal='your_div_id' data-backdrop='static' data-keyboard='false' data-name="<?php echo $vector[1]; ?> <?php echo $vector[2]; ?>" data-id="<?php echo $vector[0]; ?>"  data-toggle='modal' data-target='#myModal'>Cambiar Licencia</button></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Cambiar Licencia a &nbsp; <input type="text" readonly="readonly" style="border: none; width: 400px"  name="nomb" id="nomb"/></h4>
                </div>
...
<div id='muestralo3'>
<label class='col-md-4 control-label' for='nombresv'>Licencias</label>  
  <div  class='col-md-6'>
...
pg_query("BEGIN");	
      ...
      $result=pg_query($conexion,"UPDATE pastor SET  licencia='$licenciaa'
 WHERE idpastor='$lista'" );
