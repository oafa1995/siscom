...
function mandar(id){
	window.open("crearMiembroPDistrito.php?iddatos2="+Base64.encode(id), '_parent');
	}
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Escoja iglesia para crear al miembro</span></h4>
                </li>
				</center>
...
<td align="left"><font size="1" ></font><?php echo $vector[3]; ?></td>
	...
	<td align="left"><font size="4" ></font><button type="button" id="cancelar" name="cancelar" onClick="mandar('<?php echo $vector[0]; ?>')" class="btn btn-info">crear miembro</button></td>
