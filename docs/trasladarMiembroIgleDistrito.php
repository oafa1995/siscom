...
$idiglesiax=base64_decode($_REQUEST['idiglesia']);
...
$query_s=pg_query($conexion,"select nombre,zona,iddistrito,departamento,municipio,idiglesia from iglesia where idiglesia='$idiglesiax' ");
...
function alertaExito(){
	...
	function r() {
	location.href="trasladarMiembroDistrito.php"
} 
...
/////// si primero escoge el sexo para determinar la sociedad
         ...
         $("#distritoN").each(function () {
			 ...
			 var igle=$("#noigle").val();
                  ...
                  $.post("mirarIgle.php", { elegido: elegido,noigle: igle }, function(data){
...
<body>
   ...
   <br>
	 ...
	 <input type="hidden" name="noigle" id="noigle" value="<?php echo $idiglesiax; ?>" />
...
<?php
				...
				$query_s=pg_query($conexion,"select idiglesia,nombre from iglesia where iddistrito='$validaZona'");
