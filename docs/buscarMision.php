...
/////////////////////////////////////////validacion nombre 
 ...
 jQuery(function($){
   ...
   $('#salario').on('keypress', function (e) {/////////validacion de numeros con dos decimales
	...
	function r(id) { location.href="buscarMision.php" } 
...
function mandar(id){
	//alert("sdjsdns"+id);
	window.open("modMision.php?idpastor="+id, '_parent');
	}
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Buscar Pastor</span></h4>
                </li>
				</center>
...
<tbody>
    ...
    <?php $conect=pg_query($conexion,"select m.idmisiones,p.nombre,m.lugarvisitado,m.fecha,m.descripcion from pastor as p, misiones as m where p.idpastor=m.idpastor"); 
      ...
      <tr>
							...
							<td align="left"><font size="2" ></font><?php echo $vector[3]; ?></td>
							<td align="left"><font size="2" ></font><?php echo $vector[4]; ?></td>
                            

                            <?php if (pg_num_rows($conect)) { 
                            	?>  
                          ...
                          <?php  	
                            ...
                            ?> ?>
                              ...
                              <td align='left'><font size='4' ></font><button type='button' id='nini' name='nini' onClick="eliminar('<?php echo $vector[0]; ?>')" class='btn btn-success'>Eliminar</button></td>
...
if(isset($_REQUEST["bandera"])){
    ...
    $idmisiX=$_REQUEST["baccion"];


if($bandera=="add"){
pg_query("BEGIN");	
$result=pg_query($conexion,"DELETE FROM misiones
 WHERE idmisiones='$idmisiX'" );
