    ...
    <li class="mobile-menu-button visible-xs" style="float: left !important;">
		 ...
		 <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Buscar Miembro Dar de Alta<small></small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
            	...
            	if (pg_num_rows($conect)>0) {
            	 ...
            	 ?>
                <li role="presentation"><a href="buscarMiembroMAlta.php"><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>Buscar Miembro Propio</a></li>
                <?php }else{ ?>
                ...
                <?php } ?>	
                <li role="presentation"><a href="buscarAltaMCDistrito.php?zona=<?php echo $validaZona; ?>"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Buscar Miembro de otra iglesia</a></li>
