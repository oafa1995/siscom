...
<body>
 ...
 <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a href="miembrosLocalesDistrito.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Imprimir Miembros Locales</a></li>
				<li role="presentation"><a href="miembrosJovenesLocalDistrito.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-male-female zmdi-hc-fw"></i>Imprimir Sociedad de Jovenes Local</a></li>
				<li role="presentation"><a href="miembrosSenLocalDistrito.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-male zmdi-hc-fw"></i>Imprimir Sociedad de Señores Local</a></li>
								<li role="presentation"><a href="miembrosSenaLocalDistrito.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-female zmdi-hc-fw"></i>Imprimir Sociedad de Señoras Local</a></li>
			...
			<br>
			<ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
				<li role="presentation"><a href="iglesiaSegunDistritoDistrito.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-local-store zmdi-hc-fw"></i>Iglesias por Distrito</a></li>
