...
$idiglesiax=base64_decode($_REQUEST['idpastor']);
include("../config/conexion.php"); 
$query_s24=pg_query($conexion,"select nombre,direccion,telefono,iddistrito from iglesia where idiglesia='$idiglesiax' ");	
...
function r() {
	location.href="escogerIglesiaDistrito.php"
} 
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Modificar Iglesia</span></h4>
                </li>
				</center>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="nombre" name="nombre" value="<?php echo $nombrex; ?>" autocomplete="off" type="text" placeholder="" class="form-control input-md" value="<?= (isset($_POST['nombre']))?$_POST['nombre']:""; ?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="direccion" name="direccion" value="<?php echo $direccionx; ?>" autocomplete="off" type="text" placeholder="" class="form-control input-md" value="<?= (isset($_POST['nombre']))?$_POST['nombre']:""; ?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="telefono" name="telefono" value="<?php echo $telefonox; ?>" autocomplete="off" type="text" placeholder="" class="form-control input-md" value="<?= (isset($_POST['telefono']))?$_POST['telefono']:""; ?>"  required>
...
$distrito=pg_escape_literal($distrito);
   ...
   $result=pg_query($conexion,"UPDATE iglesia SET nombre={$nombre}, direccion={$direccion},telefono={$telefono},iddistrito={$distrito} WHERE idiglesia='$idiglesiax'" );
