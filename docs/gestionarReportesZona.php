...
<body>
 ...
 <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a href="miembrosLocalesZona.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Imprimir Miembros Locales</a></li>
				<li role="presentation"><a href="miembrosJovenesLocalZona.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-male-female zmdi-hc-fw"></i>Imprimir Sociedad de Jovenes Local</a></li>
				<li role="presentation"><a href="miembrosSenLocalZona.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-male zmdi-hc-fw"></i>Imprimir Sociedad de Señores Local</a></li>
								<li role="presentation"><a href="miembrosSenaLocalZona.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-female zmdi-hc-fw"></i>Imprimir Sociedad de Señoras Local</a></li>
			...
			<br>
			<ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
				<li role="presentation"><a href="buscarDistritoZona.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-local-store zmdi-hc-fw"></i>Iglesias por Distrito</a></li>
				<li role="presentation"><a href="iglesiaSegunZonaZona.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-local-store zmdi-hc-fw"></i>Iglesias por Zona</a></li>
            </ul>
        </div>
