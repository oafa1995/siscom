...
$query_s= pg_query($conexion, "select distinct m.idmiembro,m.nombre,m.apellido,m.fechanacimiento,m.estadocivil,m.sexo,m.dui,mi.idiglesia from miembro as m,miembro_iglesia as mi,iglesia as i where m.estado=1 and m.idmiembro=mi.idmiembro and date_part('year',age(fechanacimiento))<30 and m.estadocivil='Soltero' and i.zona='$zona' order by apellido");
