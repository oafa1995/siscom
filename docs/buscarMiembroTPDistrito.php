...
function alertaExito(){
	...
	function r() {
	location.href="buscarMiembroP.php"
} 
...
function mandar(idmiembro,idiglesia){
	//alert("sdjsdns"+id);
	window.open("trasladarMiembroIgleDistrito.php?idmiembro="+idmiembro+"&idiglesia="+idiglesia, '_parent');
	}
           ...
           <center>
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Buscar miembro para la iglesia: <?php echo $rnombre; ?></span></h4>
                </li>
				</center>    
    ...
    <?php $conect=pg_query($conexion,"select m.idmiembro,m.nombre,m.apellido,m.sexo,m.fechanacimiento,m.dui,m.profeuofi,m.estadocivil from miembro as m,miembro_iglesia as mi where m.estado=1 and mi.idiglesia='$idiglesia' and m.idmiembro=mi.idmiembro "); 
      ...
      <tr>
		...
		<td align="left"><font size="3" ></font>sociedad de señores</td>
               ...
               <td align="left"><font size="4" ></font><button type="button" id="cancelar" name="cancelar" onClick="mandar('<?php echo base64_encode($vector[0]); ?>','<?php echo base64_encode($idiglesia[0]); ?>')" class='btn btn-success'>Trasladar
               </button></td>
