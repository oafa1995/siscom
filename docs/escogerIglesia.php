  ...
  <div class="container-fluid"  style="margin: 50px 0;">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a  href="escogerZonaI.php"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Buscar por Zona</a></li>
            
                <li role="presentation"><a href="escogerDistritoI.php"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Buscar por distrito</a></li>
