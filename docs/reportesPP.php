...
<body>
 ...
 <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a href="miembrosLocalesR.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i>Imprimir Miembros Locales</a></li>
				<li role="presentation"><a href="miembrosJovenesLocalR.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-male-female zmdi-hc-fw"></i>Imprimir Sociedad de Jovenes Local</a></li>
				<li role="presentation"><a href="miembrosSenLocalR.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-male zmdi-hc-fw"></i>Imprimir Sociedad de Señores Local</a></li>
								<li role="presentation"><a href="miembrosSenaLocalR.php"><i class="zmdi zmdi-print zmdi-hc-fw"></i><i class="zmdi zmdi-female zmdi-hc-fw"></i>Imprimir Sociedad de Señoras Local</a></li>
