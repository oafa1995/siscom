...
/////////////////////////////////////////validacion nombre 
 ...
 function mandamos(){
  if (document.getElementById('cargar').value!=""&&document.getElementById('pastro').value!="") {
  alertify.confirm("<center>ATENCI&Oacute;N!</center>", "<center><img src='../img/warning.png' width='230' height='230'></center>"+"<center><h1>El pastor seleccionado perdera todos los cargos y solo tendra el de presidente ?</h1></center>  <h2 style='font-style:italic';>  </h2>", 
  ...
  alertaError();
	...
	function alertaError(){
	alertify.error("<h1>Error</h1>"+"<p>No selecciono un cargo o pastor</p>"+"<img src='../img/error.png'>").dismissOthers();
	...
	function r() { location.href="asignarCargoP.php"} 
...
$(document).ready(function (e) {
  $('#myModal').on('show.bs.modal', function(e) { 
     var id = $(e.relatedTarget).data().id;
            ...
            $.post("cargos.php", { elegido: id }, function(data){
...
$(document).ready(function (e) {
  $('#myModal2').on('show.bs.modal', function(e) { 
     var id = $(e.relatedTarget).data().id;
            ...
            $.post("cargosQ3.php", { elegido: id }, function(data){
...
<tbody>
    ...
    <?php $conect=pg_query($conexion,"select distinct p.idpastor,p.nombre,p.apellido,p.fechanacimiento,p.estadocivil,p.dui,p.duiesposa,p.telefono,p.direccion,p.correo,p.fechain from pastor as p,cargo as c,cargo_pastor as cp,iglesia as i where c.nivel=1  and cp.idpastor=p.idpastor and c.idcargo=cp.idcargo"); 
                      while ($vector=pg_fetch_array($conect)) { 
                       ...
                       ?>
                            ...
                            <td align="left"><font size="4" ></font>
                              <select id="cargomomento" name="cargomomento" class="form-control input-md" > 
                        ...
                        ?>
                            ...
                            <?php 
                            	...
                            	//echo "<td align='left'><font size='4' ></font><button type='button' id='cancelar' name='cancelar' class='btn btn-success' data-controls-modal='your_div_id' data-backdrop='static' data-keyboard='false' data-name='".$vector[1]." ".$vector[2]."' data-id='".$vector[0]."' data-toggle='modal' data-target='#myModal'>Agregar Cargo</button></td>";
                            ...
                            ?>
                              ...
                              <td align='left'><font size='4' ></font><button type='button' id='cancelar' name='cancelar' class='btn btn-warning' data-controls-modal="your_div_id" data-backdrop="static" data-keyboard="false" data-name="<?php echo $vector[1]; ?> <?php echo $vector[2]; ?>" data-id="<?php echo $vector[0]; ?>" data-toggle='modal' data-target='#myModal2'>Transferir Cargo</button></td>
 ...
 <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Transferir Cargo de Presidente</h4>
                </div>
...
<div id="mostrar" class="container-fluid">
                ...
                <div class="modal-footer">
                    <button type="button" onClick="mandamos()" class="btn btn-primary">Transferir</button>
                </div>
...
pg_query("BEGIN");	
	   ...
	   $result=pg_query($conexion,"DELETE FROM cargo_pastor WHERE idcargo=3 and idpastor='$lista' " );
     $result=pg_query($conexion,"INSERT INTO cargo_pastor(idcargo, idpastor) VALUES ('$cargo','$lista')" );
...
if($bandera=="quitar"){
  ...
  $past=$_REQUEST["pastro"];
  
pg_query("BEGIN");  


  
     $result=pg_query($conexion,"DELETE FROM cargo_pastor WHERE idpastor='$lista'" );
          $result=pg_query($conexion,"INSERT INTO cargo_pastor(idcargo, idpastor) VALUES (3,'$lista')" );
        $result=pg_query($conexion,"DELETE FROM cargo_pastor WHERE idpastor='$past'" );
        $result=pg_query($conexion,"INSERT INTO cargo_pastor(idcargo, idpastor) VALUES (1,'$past')" );
