...
/////////////////////////////////////////validacion nombre 
 ...
 jQuery(function($){
   ...
   $('#salario').on('keypress', function (e) {/////////validacion de numeros con dos decimales
	...
	alertify.error("<h1>Error</h1>"+"<p>La fecha de ingreso no concuerda con el año actual</p>"+"<img src='../img/error.png'>").dismissOthers();
	...
	function r(id) { location.href="crearMision.php?idpastor="+id } 
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Crear Mision</span></h4>
                </li>
				</center>
...
<input type="hidden" name="limite" id="limite" value="<?php echo date("Y"); ?>" />
...
<div class="form-group">
  <label class="col-md-2 control-label" for="nombresv">Pastor</label>  
  <div class="col-md-4">
  <select id="pastor" name="pastor" class="form-control input-md" >
  <option value="" disabled selected>Escoja al Pastor</option>
  ...
  <?php
                include("../config/conexion.php");
					...
					$query_s=pg_query($conexion,"select p.idpastor,p.nombre,p.apellido from pastor as p,iglesia as i where i.idpastor=p.idpastor");
		
			
								
								while($fila=pg_fetch_array($query_s)){
						                          
								                   echo " <option value='$fila[0]'>$fila[1] $fila[1]</option>";       
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-2 control-label" for="telefono">Descripcion</label>  
  <div class="col-md-8">
  <textarea id="descripcion" name="descripcion" rows="4" cols="50" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['nombre']))?$_POST['nombre']:""; ?>" required></textarea>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-2 control-label" for="telefono">Lugar</label>  
  <div class="col-md-8">
  <textarea id="lugar" name="lugar" rows="4" cols="50" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['nombre']))?$_POST['nombre']:""; ?>" required></textarea>
    
  </div>
</div>

<div class="form-group">
  <label class="col-md-2 control-label" for="password">Fecha </label>  
  <div class="col-md-5">
  
   <input type="date" id="fecha" name="fecha" required class="input-xxlarge" autocomplete="off" class="form-control input-md" onkeydown="return false;" value="<?= (isset($_POST['fechaN']))?$_POST['fechaN']:""; ?>" required>
...
$pastor=pg_escape_literal($pastor);
 $lugar=pg_escape_literal($lugar);
$descripcion=pg_escape_literal($descripcion);

	$fecha=pg_escape_literal($fecha);

	

	 $result=pg_query($conexion,"insert into misiones(idpastor,lugarvisitado,fecha,descripcion) values({$pastor},{$lugar},{$fecha},{$descripcion})" );
