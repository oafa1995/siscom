...
<article class="post clearfix"><a href="#" class="thumb pull-left"><img src="../img/sin.png" alt="espere un momento" class="img-responsive" width="100" height="100"></a>
 ...
 <h3>Registro Igles&iacute;a por Distrito: <?php echo $zona; ?><br>Iglesia Pentecostal del Nombre de Jesus&nbsp;&nbsp;&nbsp;</h3>
...
$query_s= pg_query($conexion, "select distinct i.nombre,i.direccion,i.telefono,i.zona,i.departamento,i.municipio,i.idpastor,i.encargadonp from iglesia as i,pastor as p where i.iddistrito='$zona'");
