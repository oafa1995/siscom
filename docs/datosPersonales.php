...
$iddatos=$_SESSION["nivelUsuario"];
 ...
 if($_SESSION['autenticado']!="yeah" || ($iddatos!=1 && $iddatos!=2 && $iddatos!=4 && $iddatos!=5) ){
header("Location: ../index.php");
	exit();
	}
$idpastorx=$_SESSION["idUsuario"];
include("../config/conexion.php"); 
$query_s24=pg_query($conexion,"select * from pastor where idpastor='$idpastorx' ");	
...
$correox=$fila[11];
$estadoCx=$fila[4];
$nombreesposax=$fila[5];
$duiesposax=$fila[7];
$fechaEx=$fila[6];
}

$fechaNxr = strtotime($fechaNx);
$edadx = date('Y', $fechaNxr);
 if (($mes = (date('m') - date('m', $fechaNxr))) < 0) {
  $edadx++;
 } elseif ($mes == 0 && date('d') - date('d', $fechaNxr) < 0) {
  $edadx++;
 }
$edadxy=date('Y') - $edadx;
...
/////////////////////////////////////////validacion nombre 
 ...
 jQuery(function($){
   ...
   $('#salario').on('keypress', function (e) {/////////validacion de numeros con dos decimales
	...
	function r() { location.href="buscarPastor.php?idpastor="} 
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Datos Personales</span></h4>
                </li>
				</center>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input type="text" id="nombre"  name="nombre" value="<?php echo $nombrex; ?>" placeholder="" class="form-control input-md" autocomplete="off"  value="<?= (isset($_POST['nombre']))?$_POST['nombre']:""; ?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="apellido" name="apellido" type="text" value="<?php echo $apellidox; ?>" placeholder="" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['apellido']))?$_POST['apellido']:""; ?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input id="dui" name="dui" type="text" value="<?php echo $duix; ?>" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['telefono']))?$_POST['telefono']:""; ?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-5">
   ...
   <input type="date" id="fechaN" name="fechaN" value="<?php echo $fechaNx; ?>" required class="input-xxlarge" autocomplete="off" class="form-control input-md" onkeydown="return false;" value="<?= (isset($_POST['fechaN']))?$_POST['fechaN']:""; ?>" required>
...
<div class="form-group">
  ...
  <option value="<?php echo $edadxy; ?>" selected><?php echo $edadxy; ?></option>
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input id="telefono" name="telefono" type="text" value="<?php echo $telefonox; ?>" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['telefono']))?$_POST['telefono']:""; ?>" required>
...
<div class="form-group">
  ...
  <?php $fechaactuak=date("Y-m-d"); ?>
   <input type="date" id="fechaIn" name="fechaIn" value="<?php echo $fechaInx; ?>" class="input-xxlarge" min="2001-01-01" max="<?php echo $fechaactuak; ?>" onkeydown="return false;" autocomplete="off" class="form-control input-md" value="<?= (isset($_POST['fechaIn']))?$_POST['fechaIn']:""; ?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="direccion" name="direccion" type="text" value="<?php echo $direccionx; ?>" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['direccion']))?$_POST['direccion']:""; ?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="correo" name="correo" type="text" value="<?php echo $correox; ?>" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['correo']))?$_POST['correo']:""; ?>" required>
...
<!-- Text input-->
<div id="cambio" style="visibility: visible;" class="form-group">
  <label class="col-md-4 control-label" for="nombre">Nombres completo de la esposa</label>  
  <div class="col-md-5">
  <input type="text" id="nombreE" name="nombreE" value="<?php echo $nombreesposax; ?>" placeholder="" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['nombre']))?$_POST['nombre']:""; ?>" required>
...
<!-- Text input-->
<div id="duiers" style="visibility: visible;" class="form-group">
  <label class="col-md-4 control-label" for="telefono">DUI esposa</label>  
  <div class="col-md-2">
  <input id="duiE" name="duiE" type="text" value="<?php echo $duiesposax; ?>" class="form-control input-md" autocomplete="off" value="<?= (isset($_POST['telefono']))?$_POST['telefono']:""; ?>" required>
...
<!-- Text input-->
<div id="fechaers" style="visibility: visible;" class="form-group">
  <label class="col-md-4 control-label" for="password">Fecha de nacimiento Esposa</label>  
  <div class="col-md-5">
  
   <input type="date" id="fechaE" name="fechaE" value="<?php echo $fechaEx; ?>" required class="input-xxlarge" autocomplete="off" class="form-control input-md" onkeydown="return false;" value="<?= (isset($_POST['fechaN']))?$_POST['fechaN']:""; ?>" required>
...
$fechaE=pg_escape_literal($fechaE);
	...
	$query_s2=pg_query($conexion,"select * from pastor where correo={$correo} and idpastor!='$idpastorx' ");
	...
	if($rows==0){
             ...
             if ($estadoC2=="soltero") {
             	...
             	pg_query("commit");
             	$result=pg_query($conexion,"UPDATE pastor SET  nombre={$nombre}, apellido={$apellido}, fechanacimiento={$fechaN}, estadocivil={$estadoC}, nombreesposa=null, fechanacimientoes=null, duiesposa=null,dui={$dui}, telefono={$telefono}, direccion={$direccion}, correo={$correo}, fechain={$fechaIn} WHERE idpastor='$idpastorx'" );
             }else{

             	if ($nombreE!=""&&$fechaE!=""&&$duiE!="") {
             		pg_query("commit");
             		$result=pg_query($conexion,"UPDATE pastor SET nombre={$nombre}, apellido={$apellido}, fechanacimiento={$fechaN}, estadocivil={$estadoC},nombreesposa={$nombreE}, fechanacimientoes={$fechaE}, duiesposa={$duiE}, dui={$dui}, telefono={$telefono}, direccion={$direccion}, correo={$correo}, fechain={$fechaIn} WHERE idpastor='$idpastorx'" );
             	}
             }
