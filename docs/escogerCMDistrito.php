    ...
    <li class="mobile-menu-button visible-xs" style="float: left !important;">
		 ...
		 <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Crear Miembro <small></small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
            	...
            	if (pg_num_rows($conect)>0) {
            	 ...
            	 ?>
                <li role="presentation"><a href="crearMiembroM.php"><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>Crear Miembro Propio</a></li>
                <?php }else{ ?>
                <li role="presentation" style="cursor: pointer" onClick="ver();"><a><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>Crear Miembro Propio</a></li>
                <?php } ?>	
                <li role="presentation"><a href="buscarImDistrito.php?id=<?php echo base64_encode($validaZona); ?>"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Crear Miembro de otra iglesia</a></li>
