        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
            	...
            	if (pg_num_rows($conect)>0) {
            	 ...
            	 ?>
                <li role="presentation"><a href="buscarMiembroM.php"><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>Buscar Miembro Propio</a></li>
                <?php }else{ ?>
                ...
                <?php } ?>	
                <li role="presentation"><a href="escogerZonaPBuscar.php"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Buscar Miembro de otra iglesia</a></li>
