...
<html>
<head>
    <title>Imprimiendo Sociedad de Señoras a Nivel Nacional</title>
    <meta charset="UTF-8">
...
<br>
       ...
       <tbody>
			    <?php
						...
						?>
			   <?php if((obtener_edad($fila[3])>=30 && $fila[4]=="Soltero" && $fila[5]=="Femenino") || (obtener_edad($fila[3])>=18 && $fila[4]=="Casado" && $fila[5]=="Femenino") ){ ?>
            <tr>
