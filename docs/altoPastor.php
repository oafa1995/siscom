 ...
 jQuery(function($){
   ...
   $('#salario').on('keypress', function (e) {/////////validacion de numeros con dos decimales
	...
	function mandar(id,nombre,apellido) { 
		alertify.confirm("<center>ATENCI&Oacute;N!</center>", "<center><img src='../img/warning.png' width='230' height='230'></center>"+"<center><h1>Desea dar de alta al pastor </h1><h2 style='font-style:italic';>"+nombre+" "+apellido+" ?</h2></center>    ", 
			...
			<!--aqui va la foto del usuario -->
				...
				<br>
				 <li style="color:#fff; cursor:default;">
                    <h4><span class="all-tittles">Alta Pastor</span></h4>
                </li>
				</center>
...
<tbody>
    ...
    <?php $conect=pg_query($conexion,"select p.idpastor,p.nombre,p.apellido,p.fechanacimiento,p.estadocivil,p.dui,p.duiesposa,p.telefono,p.direccion,p.correo,p.fechain from pastor as p,cargo as c,cargo_pastor as cp where c.nivel=0  and cp.idpastor=p.idpastor and c.idcargo=cp.idcargo"); 
      ...
      <tr>
                       ...
                       ?>
                            ...
                            if (pg_num_rows($conect2)) {  ?>
                            	<td align="left"><font size="4" ></font><button type="button" id="cancelar" name="cancelar" onClick="mandar('<?php echo $vector[0]; ?>','<?php echo $vector[1]; ?>','<?php echo $vector[2]; ?>')" class="btn btn-success">Dar alta</button></td>
                          <?php  }else{  ?>
...
pg_query("BEGIN");	
	   ...
	   $result=pg_query($conexion,"insert into cargo_pastor(idcargo,idpastor) values(3,$idpastor)" );  
